...
function Stop-HermesDesktopOwnedProcesses {
    ...
    # Windows file-system filters and antivirus can retain a handle briefly
    # after the owning process exits. Give those filters a bounded release
    # window before Git, setup or launcher promotion touches the checkout.
