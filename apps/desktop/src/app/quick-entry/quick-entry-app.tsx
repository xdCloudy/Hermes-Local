    ...
    >
      ...
      >
        ...
        <div style={{ alignItems: 'center', display: 'flex', gap: 8 }}>
          ...
          <Select
            disabled={!state.connected}
            onValueChange={target => dispatch({ target, type: 'target' })}
            value={state.target}
          >
            <SelectTrigger
            ...
            <SelectContent align="end">
              <SelectItem value={QUICK_TARGET_CURRENT}>Current chat</SelectItem>
              <SelectItem value={QUICK_TARGET_NEW}>New session</SelectItem>
