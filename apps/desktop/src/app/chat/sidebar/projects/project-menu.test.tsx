...
vi.mock('@/store/projects', () => ({
  $pinnedProjectIds: atom(new Set<string>()),
  copyPath: vi.fn(),
  deleteProject: vi.fn(),
  openProjectAddFolder: vi.fn(),
  openProjectCentre: vi.fn(),
  openProjectRename: vi.fn(),
  removeProjectRegistration: vi.fn(),
  revealPath: vi.fn(),
  setActiveProject: vi.fn(),
  setProjectAppearance: vi.fn().mockResolvedValue(false),
  setProjectArchived: vi.fn().mockResolvedValue(false),
  setProjectPinned: vi.fn().mockResolvedValue(false)
}))
