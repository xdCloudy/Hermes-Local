...
const SIDEBAR_NAV: SidebarNavItem[] = [
  {
    id: 'home',
    label: '',
    icon: props => <Codicon name="home" {...props} />,
    route: HOME_ROUTE
  },
  {
    id: 'chat',
  ...
  },
  {
    ...
    route: LOCAL_PROFILES_ROUTE
  },
  {
    id: 'memory',
    label: '',
    icon: props => <Codicon name="database" {...props} />,
    route: MEMORY_ROUTE
  },
  {
    id: 'skills',
  ...
  },
  {
    id: 'trust',
    label: 'Trust Centre',
    icon: props => <Codicon name="lock" {...props} />,
    route: TRUST_ROUTE
  },
  {
    id: 'restore',
  ...
  },
  {
    id: 'logs',
    label: '',
    icon: props => <Codicon name="output" {...props} />,
    route: LOGS_ROUTE
  },
  {
    id: 'settings',
  ...
  },
  {
    id: 'about',
    label: '',
    icon: props => <Codicon name="info" {...props} />,
    route: ABOUT_ROUTE
  }
]
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    const loadActiveTasks = async () => {
      try {
        const tasks = await window.hermesDesktop.localWorkstation.listActions()
    ...
    const timer = window.setInterval(() => void loadActiveTasks(), 2000)
                ...
                const button = (
                  ...
                  >
                    ...
                    {item.id === 'tasks' && activeTaskCount > 0 && (
                      <span
                        aria-label={`${activeTaskCount} active task${activeTaskCount === 1 ? '' : 's'}`}
                        className="grid min-w-5 place-items-center rounded-md bg-(--ui-accent) px-1.5 font-mono text-[0.625rem] font-semibold text-white"
                      >
