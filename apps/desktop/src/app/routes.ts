...
export const LEGACY_TOOLS_REDIRECT_ROUTE = SKILLS_ROUTE
...
export const APP_ROUTES = [
  ...
  { id: 'home', path: HOME_ROUTE, view: 'workstation' },
  { id: 'tui', path: TUI_ROUTE, view: 'workstation' },
  { id: 'dashboard', path: DASHBOARD_ROUTE, view: 'workstation' },
  { id: 'tasks', path: TASKS_ROUTE, view: 'workstation' },
  { id: 'services', path: SERVICES_ROUTE, view: 'workstation' },
  { id: 'models', path: MODELS_ROUTE, view: 'workstation' },
  { id: 'local-profiles', path: LOCAL_PROFILES_ROUTE, view: 'workstation' },
  { id: 'tools', path: TOOLS_ROUTE, view: 'workstation' },
  { id: 'memory', path: MEMORY_ROUTE, view: 'workstation' },
  { id: 'sessions', path: SESSIONS_ROUTE, view: 'workstation' },
  { id: 'projects', path: PROJECTS_ROUTE, view: 'workstation' },
  { id: 'benchmarks', path: BENCHMARKS_ROUTE, view: 'workstation' },
  { id: 'security', path: SECURITY_ROUTE, view: 'workstation' },
  { id: 'trust', path: TRUST_ROUTE, view: 'workstation' },
  { id: 'restore', path: RESTORE_ROUTE, view: 'workstation' },
  { id: 'logs', path: LOGS_ROUTE, view: 'workstation' },
  { id: 'about', path: ABOUT_ROUTE, view: 'workstation' }
