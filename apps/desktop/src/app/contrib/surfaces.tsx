...
const LocalWorkstationView = lazy(async () => ({ default: (await import('../local-workstation')).LocalWorkstationView }))
const HermesTuiPanel = lazy(async () => ({ default: (await import('../local-workstation/tui-panel')).HermesTuiPanel }))
...
export const ChatRoutesSurface = memo(function ChatRoutesSurface({
  ...
  return (
    <Routes>
      ...
      <Route element={page(<LocalWorkstationView />)} path="home" />
      <Route element={page(<HermesTuiPanel />)} path="tui" />
      <Route element={page(<LocalWorkstationView />)} path="dashboard" />
      <Route element={page(<LocalWorkstationView />)} path="tasks" />
      <Route element={page(<LocalWorkstationView />)} path="services" />
      <Route element={page(<LocalWorkstationView />)} path="models" />
      <Route element={page(<LocalWorkstationView />)} path="local-profiles" />
      <Route element={<Navigate replace to={LEGACY_TOOLS_REDIRECT_ROUTE} />} path="tools" />
      <Route element={page(<LocalWorkstationView />)} path="memory" />
      <Route element={page(<LocalWorkstationView />)} path="sessions" />
      <Route element={page(<LocalWorkstationView />)} path="projects" />
      <Route element={page(<LocalWorkstationView />)} path="benchmarks" />
      <Route element={page(<LocalWorkstationView />)} path="security" />
      <Route element={page(<LocalWorkstationView />)} path="trust" />
      <Route element={page(<LocalWorkstationView />)} path="logs" />
      <Route element={page(<LocalWorkstationView />)} path="about" />
