...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    alias: {
      ...
      '@hermes/shared/billing': path.resolve(__dirname, '../../packages/hermes-agent-client/src/billing-types.ts'),
      '@hermes/shared': path.resolve(__dirname, '../../packages/hermes-agent-client/src'),
